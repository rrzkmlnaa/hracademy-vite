  ...
  return (
    <div className="flex flex-col gap-3 md:gap-6">
      {services.map((service, index) => (
        <div key={index} className="w-full max-w-md p-3 rounded-xl text-white">
...
export const services = [
  ...
  },
  {
    ...
    description:
      "29% HR Supervisor dan 46% dari HR Manager memiliki sertifikasi, menunjukkan bahwa sertifikasi dapat membantu dalam mencapai posisi yang lebih tinggi",
  },
  {
