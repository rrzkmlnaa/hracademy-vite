    ...
    details: [
      {
        name: "Send your CV",
        description:
          "Send us your CV along with your career objectives to help us understand how best to assist you!",
      },
      {
        name: "We Fix Your CV",
        description:
          "We’ll refine your CV to highlight why you’re the ideal candidate for the job in 1-3 days. ",
      },
      {
        name: "Feedback Session",
        description:
          "Personalized session where we discuss your CV to ensure it aligns perfectly with your goals.",
      },
      {
        name: "Receive your CV",
        description:
          "We will send your revised CV along with personalized comments to enchance and helped you get your dream job. ",
      },
      {
...
export default function Index() {
  ...
  return (
    <>
      <Jumbotron imageName="cv-revision.png">
        ...
        <p className="mt-4 max-w-xl text-xl/relaxed text-center md:text-start">
          CRAFT A RESUME THAT LANDS YOUR DREAM JOB. LET US TRANSFORM YOUR CV AND
        ...
        <div className="sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl w-full h-auto mx-auto py-40">
          ...
          <div className="w-full h-auto flex flex-wrap justify-center items-center gap-5 md:gap-50 text-white pt-10">
            <UnstyledLink to="#priceView">
              <Button
                onClick={() => {
                  handlePriceChange("Price is Rp. 25.000");
                }}
            ...
            <UnstyledLink to="#priceView">
              <Button
                onClick={() => {
                  handlePriceChange("Price is Rp. 100.000");
                }}
                className="relative py-5 px-8"
                variant="primary"
              >
            ...
            <UnstyledLink to="#priceView">
              <Button
                onClick={() => {
                  handlePriceChange("Price is Rp. 50.000");
                }}
                className="relative py-5 px-8"
                variant="primary"
              >
