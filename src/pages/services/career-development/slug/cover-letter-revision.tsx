    ...
    details: [
      {
        ...
        description:
          "Send us your Cover Letter along with your career objectives to help us understand you!",
      },
      {
        name: "We Fix Your Cover Letter",
        description:
          "We'll refine your Cover Letter to demonstrate why you're an ideal fit for the role you seek.",
      },
      {
        name: "Feedback Session",
        description:
          "You'll receive the initial draft and we'll address any questions you have. Your input will shape the final version.",
      },
      {
    ...
    <>
      <Jumbotron imageName="job-search.png">
        ...
        <p className="mt-4 max-w-xl text-xl/relaxed text-center md:text-start">
          WE KNOW WHAT COMPANIES WANT IN A COVER LETTER. WE'LL REWRITE YOURS TO
          FIT YOUR DREAM JOB PERFECTLY.
        </p>
      </Jumbotron>
