...
export const detail = [
  {
    ...
    details: [
      ...
      },
      {
        ...
        description:
          "After reviewing your questionnaire, we'll contact you to set up first coaching schedule.",
      },
      {
        name: "First Consultation",
        description:
          "We'll talk about your job search experience and our strategies in a call to help kick-start your journey.",
      },
      {
        name: "We develop your strategy",
        description:
          "We tailored presentation  strategy presentation addressing your questions and employment goals.",
      },
      {
        name: "Receive your job search strategy deck",
        description:
          " Receive a personalized strategy that guides you on networking, standing out, and securing a job in your desired industry.",
      },
    ],
  },
];
    ...
    <>
      <Jumbotron imageName="linkedin-rev.png">
        ...
        <p className="mt-4 max-w-xl text-xl/relaxed text-center md:text-start">
          IN TODAY'S JOB MARKET, NETWORKING IS CRUCIAL. EXPAND YOUR PROFESSIONAL
          NETWORK AND ATTRACT MORE EMPLOYERS WITH OUR EXPERT LINKEDIN
          STRATEGIES.
        </p>
      </Jumbotron>
