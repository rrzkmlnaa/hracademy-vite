    ...
    details: [
      {
        name: "Get In Touch",
        description:
          "Complete a questionnaire to share information about yourself, your career goals, experience, and skills. This helps us understand how to assist you better!",
      },
      {
        name: "Schedule Consultation",
        description:
          "After reviewing your questionnaire, we'll contact you to set up the first coaching schedule.",
      },
      {
        name: "Initial Coaching Session",
        description:
          "In your first coaching session, we'll delve into your background, assess your issues, understand your expectations, and set a goal for you.",
      },
      {
        name: "CV and Linkedin Review",
        description:
          "We'll review your CV and LinkedIn profile to ensure they effectively highlight your skills and experiences.",
      },
      {
        name: "Closing and Follow-Up",
        description:
          "This session aims to review your assignment results, identify any gaps, and determine the next steps to help you secure your dream career.",
      },
    ],
  },
  {
    ...
    details: [
      ...
      },
      {
        ...
        description:
          "In your first coaching session, we align the goals, expectations, and the current situation to ensure the coaching process meets your needs effectively.",
      },
      {
        name: "Coaching Session",
        description:
          "You, guided by the coach, work to find solutions to your challenges.",
      },
      {
        name: "CV and Linkedin Review",
        description:
...
export default function Index() {
  ...
  return (
    <>
        ...
        <div className="text-center sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl w-full h-auto">
          ...
          <div className="flex flex-col items-center justify-center gap-5 w-full px-4">
            <p className="text-base w-full md:w-1/2">
              Coaching is a <strong>partnership with individuals</strong> in a
              creative process, to encourage and support someone, or even a team
              to achieve a goal in a measurable manner, and provide
              opportunities for coachees to develop or master certain skills
            </p>
            <p className="text-base w-full md:w-1/2">
              <strong>The purpose of coaching is a to guide</strong> the
              coachee, where in the process a coach assists the coachee in
              achieving self-determined goals by facilitating thought,
              generating insights, structuring thinking, and ensuring
        ...
        <div className="sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl w-full h-auto mx-auto py-40">
          ...
          <div className="w-full h-auto flex flex-wrap justify-center items-center gap-5 md:gap-50 text-white pt-10">
            <UnstyledLink to="#priceView">
              <Button
                onClick={() => {
                  ...
                  setShowLessThanYearDetails(true);
                  setShowMoreThanYearDetails(false);
                }}
            ...
            <UnstyledLink to="#priceView">
              <Button
                onClick={() => {
                  handlePriceChange("Price is Rp. 500.000");
                  setShowLessThanYearDetails(false);
                  setShowMoreThanYearDetails(true);
                }}
                className="relative py-5 px-8"
                variant="primary"
              >
      ...
      <Ready colorstyle="bg-blue-700 text-white p-10">
