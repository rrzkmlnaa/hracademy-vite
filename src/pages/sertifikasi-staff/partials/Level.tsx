      ...
      text: (
        <div className="flex items-center">
          ...
          <div className="flex-1">
            <span className="font-extrabold">Cakupan materi </span>
            Standar Kompetensi Kerja Nasional Indonesia{" "}
            <span className="font-extrabold">
              (SKKNI) dan Standar </span>degree dari HR Academy
          </div>
        </div>
      ),
    },
    ...
    },
    {
      text: (
        <div className="flex items-center">
          <FaCheckCircle className="text-primary text-3xl mr-4" />
          <div className="flex-1">
            <span className="font-extrabold">Metode Belajar Praktek</span>
            <br />
            Metode belajar yang mengedepankan praktek sehingga meningkatkan pemahaman peserta secara mendalam. 
          </div>
        </div>
      ),
    },
    ...
    },
    {
      text: (
        <div className="flex items-center">
          <FaCheckCircle className="text-primary text-3xl mr-4" />
          <div className="flex-1">
            <span className="font-extrabold text-[16px]">Jaringan HR dan Alumni</span>
            <br />
