...
export default function Jumbotron({ imageName, children }: PropsType) {
    ...
    return (
        ...
        <div className="mx-auto h-screen max-w-screen-xl px-6 py-32 text-white md:px-10 lg:flex flex justify-center items-center lg:items-center md:flex md:items-center lg:px-8">
